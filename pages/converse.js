...
const ConverseProducts = ({ prices }) => {
	const { state, dispatch } = useAppContext();

	const conversePrices = Object.values(prices).filter((item) => {
		return item.product.metadata["Brand"] === "Converse";
	});
	...
	return (
		<div className='border-b-2 border-zinc-700 pb-24 relative'>
			...
			<div className='w-10/12 mx-auto grid grid-cols-2 gap-4 md:grid-cols-4 lg:gap-8 lg:grid-cols-8 lg:grid-rows-2 '>
				...
				{conversePrices.map((price, index) => {
					return (
...
export default ConverseProducts;
