	...
	return (
		<div className='border-b-2 border-zinc-700 pb-24'>
			...
			<div className='w-full flex items-center mt-16'>
				<button
					onClick={() => Router.push("/")}
					className='border border-slate-900 bg-red-200 text-slate-800  py-2 px-7 uppercase mx-auto rounded-sm transition duration-300 hover:bg-white hover:text-slate-900 select-none'
				>
					back to home
				</button>
			</div>
