		...
		<div className='w-full  h-screen  relative z-0 mx-auto  overflow-hidden col-span-2 md:col-span-4 lg:row-span-2'>
			...
			<div className='min-w-full flex flex-col z-10 absolute text-center mt-10'>
				<div className='w-30 space-y-4 md:space-y-8'>
					...
					<article className=' absolute shadow-xl top-16 mx-20  bg-white bg-opacity-70 text-slate-900 border border-white font-light text-xs  tracking-wider p-6 rounded-md transition duration-300   select-none md:top-40 md:text-base lg:mx-[300px]'>
