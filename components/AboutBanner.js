			...
			<div className='min-w-full flex flex-col z-10 absolute text-center mt-20'>
				<div className='w-30 space-y-4 md:space-y-8'>
					...
					<article className=' absolute  top-16 mx-20  bg-transparent text-white border border-white font-light text-sm  tracking-wider p-6 transition duration-300 hover:bg-white hover:bg-opacity-50 hover:text-slate-900 select-none md:top-32 lg:mx-96'>
						...
						run it up the flag pole for a performance review. It's a
						simple lift and shift job. Throughput criticality,
						pre-think our game-plan. So if you could do that, that
						would be great for critical mass. Pull in ten extra
						bodies to help roll the tortoise, a loss a day will keep
						you focused, then loop back. Back-end of third quarter,
						meeting assassins get buy-in to close the loop. When
						does this sun set?
					</article>
				</div>
			</div>
